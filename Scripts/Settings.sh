...
#	fi
	...
	sed -i '/^exit 0$/i sed -i "s/${orig_version}/ ${VERSION} 编译日期：${date_version}  by 微信:Mr___zjz  /g package/base-files/files/usr/lib/os-release" package/emortal/default-settings/files/99-default-settings-chinese
